# Kiswahili: Kitabu cha Mwanafunzi Darasa la Nne — ADT Bundle Reference
...
**Kiswahili: Kitabu cha Mwanafunzi Darasa la Nne** — Hiki ni kitabu cha Kiswahili cha mwanafunzi wa Darasa la Nne kilichoandaliwa na Taasisi ya Elimu Tanzania, hivyo ni wazi kuwa kinatoka Tanzania na kimeandikwa kwa lugha ya Kiswahili. Kitabu kinashughulikia stadi kuu za lugha kama kusikiliza, kuzungumza, kusoma na kuandika, pamoja na mada za sarufi na matumizi ya lugha kama nyakati, hali timilifu, alama za uandishi, barua, hadithi, ngonjera, methali, nahau na vitendawili. Kinalenga wanafunzi wa shule ya msingi wa kiwango cha kati, na kinafundisha kwa mtindo wa umahiri kupitia hadithi, mashairi, mazungumzo, maswali ya ufahamu na mazoezi mbalimbali yanayojenga maadili, kujiamini na mawasiliano sahihi katika maisha ya kila siku.
...
```
KISWAHILI-LENYE-MABORESHO-YOTE/
├── adt/                              # THE WEB APP
...
├── KISWAHILI-LENYE-MABORESHO-YOTE.db                    # SQLite database (pipeline state)
├── KISWAHILI-LENYE-MABORESHO-YOTE.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "Cheti cha ithibati cha kitabu cha Kiswahili Darasa la Nne kutoka Jamhuri ya Muungano wa Tanzania, Wizara ya Elimu, Sayansi na Teknolojia. Kina taarifa za kitabu na sahihi ya Kamishna wa Elimu.",
  "gl001": "abiria",
  "gl001_def": "Mtu anayesafiri kwa kutumia chombo cha usafiri kama gari, basi au ndege.",
  "qz001_que": "Habari uliyosoma ilihusu nini hasa?",
  "qz001_o0": "1) Mchezo wa mpira",
  "qz001_o0_exp": "❌ Jaribu tena. Ingawa wanafunzi walifurahi, habari haikuhusu mchezo wa mpira bali mahafali."
}
```
...
```json
{
  "abiria": {
    "word": "abiria",
    "definition": "Mtu anayesafiri kwa kutumia chombo cha usafiri kama gari, basi au ndege.",
    "variations": ["abiria","wasafiri"],
    "emoji": "🚌🚶"
  }
}
```
...
```json
{
  "title": "Kiswahili: Kitabu cha Mwanafunzi Darasa la Nne",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "sw-TZ"
...
<section role="activity" data-section-type="activity_quiz" data-id="qz001"
    ...
    <p data-id="qz001_que">Habari uliyosoma ilihusu nini hasa?</p>

    <label data-activity-item="qz001_o0"
           data-explanation="❌ Jaribu tena. Ingawa wanafunzi walifurahi, habari haikuhusu mchezo wa mpira bali mahafali." data-explanation-id="qz001_o0_exp">
        <input type="radio" name="qz001" value="qz001_o0" class="sr-only" />
        <span data-id="qz001_o0">1) Mchezo wa mpira</span>
    </label>
    <!-- more options... -->
</section>
...
| Original PDF | `KISWAHILI-LENYE-MABORESHO-YOTE.pdf` |
| Pipeline database | `KISWAHILI-LENYE-MABORESHO-YOTE.db` (SQLite) |
