"""Remove navigation page 10 (qz001) and all of its bundled resources."""
...
QUIZ_IDS = {
    "qz001_que",
    "qz001_o0", "qz001_o0_exp",
    "qz001_o1", "qz001_o1_exp",
    "qz001_o2", "qz001_o2_exp",
}
...
manifest_text = manifest_text.replace('      <file href="qz001.html"/>\n', "")
manifest.write_text(manifest_text, encoding="utf-8")

scorm = ROOT / "assets/scorm.js"
scorm_text = scorm.read_text(encoding="utf-8-sig")
scorm_text = scorm_text.replace('"qz001",', "")
...
keys = [key for key in old_inline if key != "./qz001.html"]
inline = {}
for key in keys:
...
(ROOT / "qz001.html").unlink(missing_ok=True)
