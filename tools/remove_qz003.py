"""Remove navigation page 32 (qz003) and all of its bundled resources."""
...
QUIZ_IDS = {
    "qz003_que",
    "qz003_o0", "qz003_o0_exp",
    "qz003_o1", "qz003_o1_exp",
    "qz003_o2", "qz003_o2_exp",
}
...
manifest_text = manifest_text.replace('      <file href="qz003.html"/>\n', "")
manifest.write_text(manifest_text, encoding="utf-8")

scorm = ROOT / "assets/scorm.js"
scorm_text = scorm.read_text(encoding="utf-8-sig")
scorm_text = scorm_text.replace('"qz003",', "")
...
keys = [key for key in old_inline if key != "./qz003.html"]
inline = {}
for key in keys:
...
(ROOT / "qz003.html").unlink(missing_ok=True)
