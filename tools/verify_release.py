...
def main() -> None:
    ...
    for position, page in enumerate(pages, start=1):
        ...
        assert "offline-preloader.js?v=35" in html, f"Old cache version in {page['href']}"
        assert "book-consistency.css?v=35" in html, f"Typography CSS missing in {page['href']}"
        assert "inclusive-language.js?v=21" in html, f"Old inclusive-language cache version in {page['href']}"
