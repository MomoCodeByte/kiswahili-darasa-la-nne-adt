"""Remove navigation page 111 (qz009) and all of its bundled resources."""
...
QUIZ_IDS = {
    "qz009_que",
    "qz009_o0", "qz009_o0_exp",
    "qz009_o1", "qz009_o1_exp",
    "qz009_o2", "qz009_o2_exp",
}
...
manifest_text = manifest_text.replace('      <file href="qz009.html"/>\n', "")
manifest.write_text(manifest_text, encoding="utf-8")

scorm = ROOT / "assets/scorm.js"
scorm_text = scorm.read_text(encoding="utf-8-sig")
scorm_text = scorm_text.replace('"qz009",', "")
...
keys = [key for key in old_inline if key != "./qz009.html"]
inline = {}
for key in keys:
...
(ROOT / "qz009.html").unlink(missing_ok=True)
