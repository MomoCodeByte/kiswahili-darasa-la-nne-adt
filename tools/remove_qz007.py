"""Remove navigation page 74 (qz007) and all of its bundled resources."""
...
QUIZ_IDS = {
    "qz007_que",
    "qz007_o0", "qz007_o0_exp",
    "qz007_o1", "qz007_o1_exp",
    "qz007_o2", "qz007_o2_exp",
}
...
manifest_text = manifest_text.replace('      <file href="qz007.html"/>\n', "")
manifest.write_text(manifest_text, encoding="utf-8")

scorm = ROOT / "assets/scorm.js"
scorm_text = scorm.read_text(encoding="utf-8-sig")
scorm_text = scorm_text.replace('"qz007",', "")
...
keys = [key for key in old_inline if key != "./qz007.html"]
inline = {}
for key in keys:
...
(ROOT / "qz007.html").unlink(missing_ok=True)
