"""Remove navigation page 25 (qz002) and all of its bundled resources."""
...
QUIZ_IDS = {
    "qz002_que",
    "qz002_o0", "qz002_o0_exp",
    "qz002_o1", "qz002_o1_exp",
    "qz002_o2", "qz002_o2_exp",
}
...
manifest_text = manifest_text.replace('      <file href="qz002.html"/>\n', "")
manifest.write_text(manifest_text, encoding="utf-8")

scorm = ROOT / "assets/scorm.js"
scorm_text = scorm.read_text(encoding="utf-8-sig")
scorm_text = scorm_text.replace('"qz002",', "")
...
keys = [key for key in old_inline if key != "./qz002.html"]
inline = {}
for key in keys:
...
(ROOT / "qz002.html").unlink(missing_ok=True)
