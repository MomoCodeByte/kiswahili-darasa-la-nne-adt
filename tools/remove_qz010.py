"""Remove navigation page 126 (qz010) and all of its bundled resources."""
...
QUIZ_IDS = {
    "qz010_que",
    "qz010_o0", "qz010_o0_exp",
    "qz010_o1", "qz010_o1_exp",
    "qz010_o2", "qz010_o2_exp",
}
...
manifest_text = manifest_text.replace('      <file href="qz010.html"/>\n', "")
manifest.write_text(manifest_text, encoding="utf-8")

scorm = ROOT / "assets/scorm.js"
scorm_text = scorm.read_text(encoding="utf-8-sig")
scorm_text = scorm_text.replace('"qz010",', "")
...
keys = [key for key in old_inline if key != "./qz010.html"]
inline = {}
for key in keys:
...
(ROOT / "qz010.html").unlink(missing_ok=True)
