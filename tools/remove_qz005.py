"""Remove navigation page 57 (qz005) and all of its bundled resources."""
...
QUIZ_IDS = {
    "qz005_que",
    "qz005_o0", "qz005_o0_exp",
    "qz005_o1", "qz005_o1_exp",
    "qz005_o2", "qz005_o2_exp",
}
...
manifest_text = manifest_text.replace('      <file href="qz005.html"/>\n', "")
manifest.write_text(manifest_text, encoding="utf-8")

scorm = ROOT / "assets/scorm.js"
scorm_text = scorm.read_text(encoding="utf-8-sig")
scorm_text = scorm_text.replace('"qz005",', "")
...
keys = [key for key in old_inline if key != "./qz005.html"]
inline = {}
for key in keys:
...
(ROOT / "qz005.html").unlink(missing_ok=True)
