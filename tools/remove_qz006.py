"""Remove navigation page 62 (qz006) and all of its bundled resources."""
...
QUIZ_IDS = {
    "qz006_que",
    "qz006_o0", "qz006_o0_exp",
    "qz006_o1", "qz006_o1_exp",
    "qz006_o2", "qz006_o2_exp",
}
...
manifest_text = manifest_text.replace('      <file href="qz006.html"/>\n', "")
manifest.write_text(manifest_text, encoding="utf-8")

scorm = ROOT / "assets/scorm.js"
scorm_text = scorm.read_text(encoding="utf-8-sig")
scorm_text = scorm_text.replace('"qz006",', "")
...
keys = [key for key in old_inline if key != "./qz006.html"]
inline = {}
for key in keys:
...
(ROOT / "qz006.html").unlink(missing_ok=True)
